...
//Components
import TabSummary from "./sections/Summary";
import TabResume from "./sections/Resume";
...
export default function PageProfile() {
	...
	return (
		<article className='page type-page subpages'>
			<div className='entry-content'>
				{switchTab()}
				{currentTab === 1 ? (
					<div className='switch-page right' onClick={() => setCurrentTab(2)}>
						<svg
							width='18px'
							height='17px'
							viewBox='-1 0 18 17'
					...
					<div className='switch-page left' onClick={() => setCurrentTab(1)}>
						<svg
							width='18px'
							height='17px'
							viewBox='0 0 18 17'
