...
export default function Bilan() {
	return (
		<Container className='features px-0 px-md-5'>
			<Row className='justify-content-center align-items-center aos-init aos-animate' data-aos='fade-up'>
				...
				<Col md='6' className='mt-2 mt-md-0 features-details'>
					...
					<p>
						En toute franchise, je suis vraiment très content des projets que l'on a pu produire au sein du
						pôle R&D cette année. Ma plus grande fierté réside donc en notre capacité à produire des outils
						utiles et surtout utilisés, dans les deadlines qui nous étaient imposées.
					</p>
					<ul>
						<li>
						...
						<li>
							<i className='fa fa-check'></i> Développement de 3 jolis outils utiles à toutes les entités
							de F Distribution.
						</li>
						<li>
			...
			<Row className='justify-content-center align-items-center aos-init aos-animate' data-aos='fade-up'>
				...
				<Col md='6' className='mt-2 mt-md-0 features-details order-2 order-md-1'>
					...
					<p>
						...
						quelqu'un d'assez perservérant dans le développement et je n'aime pas être bloqué. Cependant un
						défaut que je n'avais pas conscience d'avoir est mon manque de communication face à ces
			...
			<Row className='justify-content-center align-items-center aos-init aos-animate' data-aos='fade-up'>
				...
				<Col md='6' className='mt-2 mt-md-0 features-details'>
					...
					<ul>
						<li>
							<i className='fa fa-check'></i> Amélioration de ma syntaxe React et découverte de nouvelles
							librairies (Redux/Mercure)
						</li>
						<li>
			...
			<Row className='justify-content-center align-items-center aos-init aos-animate' data-aos='fade-up'>
				...
				<Col md='6' className='mt-2 mt-md-0 features-details order-2 order-md-1'>
					...
					<p className='text-justify'>
						Cette expérience m'a surtout permis de prendre conscience de l'importance de faire quelque chose
						qui nous plait. En effet, réaliser que son travail est vraiment utile et surtout impacte des
						personnes plus ou moins proche de soi apporte une vision totalement différente du développement
						et surtout une vraie satisfaction !
					</p>
					<p className='text-justify'>
			...
			<Row className='justify-content-center align-items-center aos-init aos-animate' data-aos='fade-up'>
				...
				<Col md='6' className='mt-2 mt-md-0 features-details'>
					...
					<p>
						...
						entreprise sur des projets concrets, cette année m'a permit de me rassurer sur certains points
					...
					<ul>
						...
						<li>
							<i className='fa fa-check'></i> C'est un monde très vaste et il me reste encore beaucoup à
